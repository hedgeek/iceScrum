...
<is:fieldset title="is.dialog.report.generation">
      ...
      <is:progressBar
              ...
              iframe="true"
              showOnCreate="true"
              iframeSrc="${createLink(action:actionName,controller:controllerName,params:[product:params.product,get:true,format:params.format,tasks:params.tasks], id:params.id?:null)}"
